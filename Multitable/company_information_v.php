...
<head>
    ...
    <script src="https://yadcf-showcase.appspot.com/resources/js/jquery.dataTables.10.min.js"></script>
        ...
        $(document).ready(function () {
            ...
            var oTable = $('#entrys_table').DataTable({
                ...
                "ajax": {
                    ...
                    "url": "http://localhost/CodeIgniter/index.php/Company_information/ajax_list",
            ...
            yadcf.init(oTable, [{
                ...
                data: '<?php echo $_SESSION['FIELD'][5] ?>',
                column_number: 5,
                case_insensitive: true,
                filter_delay: 500,
                filter_reset_button_text: false
            }, {
                data: '<?php echo $_SESSION['FIELD'][6] ?>',
                filter_type: "text",
                column_number: 6,
                filter_reset_button_text: false
            }
