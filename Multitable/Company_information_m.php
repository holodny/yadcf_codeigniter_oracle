...
class Company_information_m extends CI_Model
{
	...
	var $table = array('SCOTT.PROJECT_PARTICIPATION PP');
	var $column_search = array('E.EMPNO', 'E.NAME', 'E.JOB', 'E.BOSS', 'E.HIREDATE' , 'P.PROJECTNO', 'P.DESCRIPTION');

	var $order = array('EMPNO' => 'desc'); // default order
